...
import { getCandidateAnalytics, getAttempts } from '@/lib/repository';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl space-y-1">
          ...
          <div className="text-3xl font-extrabold text-white">{analytics.totalTestsAttempted}</div>
        ...
        <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl space-y-1">
          ...
          <div className="text-3xl font-extrabold text-emerald-400">{analytics.averageScore}</div>
        ...
        <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl space-y-1">
          ...
          <div className="text-3xl font-extrabold text-purple-400">{analytics.highestScore}</div>
        ...
        <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl space-y-1">
          ...
          <div className="text-3xl font-extrabold text-amber-400">{analytics.overallAccuracy}%</div>
